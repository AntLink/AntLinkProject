...
class HomePageView(TemplateView):
    template_name = "prontend/home_post.html"

    def get_context_data(self, **kwargs):
        context = super(HomePageView, self).get_context_data(**kwargs)
        context['post'] = Word.objects.filter(type='post').order_by('-created_at')
        return context
...
class AddMessageView(CreateView):
    ...
    template_name = 'prontend/post_list_bay_tax.html'
...
class PostDetailView(DetailView):
    model = Word
    template_name = 'prontend/post_detail.html'
...
class PostSearchView(ListView):
    ...
    template_name = 'prontend/post_search_list.html'
    paginate_by = 10
...
class TestView(TemplateView):
    template_name = 'prontend/test.html'

    def get_context_data(self, **kwargs):
        import json, requests
        payload = {'ajax': 1, 'pn': 'p19', 'htv': 'l'}
